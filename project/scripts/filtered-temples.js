//this is for the filtred temple week04
...
const oldFilterLink = document.querySelector("#old");
...
//new filter
const newFilterLink = document.querySelector("#new");
...
const largeFilterLink = document.querySelector("#large");
...
const smallFilterLink = document.querySelector("#small");
